...
import eu.aleon.aleoncean.packet.radio.userdata.UserDataEEPF61000T2U;
...
public class RemoteDeviceEEPF61000 extends DeviceRPS implements RemoteDevice {
    ...
    public RemoteDeviceEEPF61000(ESP3Connector conn, EnOceanId addressRemote, EnOceanId addressLocal) {
    ...
    public void parseT2U(UserDataEEPF61000T2U userData) {
        try {
    ...
    public void parseRadioPacketRPS(RadioPacketRPS packet) {
        UserDataRPS userData = UserDataEEPF61000Factory.getPacketData(packet);
