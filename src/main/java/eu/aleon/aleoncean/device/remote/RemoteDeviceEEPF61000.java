...
public class RemoteDeviceEEPF61000 extends DeviceRPS implements RemoteDevice {
    ...
    public RemoteDeviceEEPF61000(final ESP3Connector conn, final EnOceanId addressRemote, final EnOceanId addressLocal) {
    ...
    public void parseT2U(final UserDataEEPF61000T2U userData) {
        try {
